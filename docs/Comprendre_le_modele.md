...
**Suppression d’un compte.** Son stock et ses préférences sont supprimés. Ses recettes restent dans le catalogue, avec un auteur vide. Cela ne donne pas à tous le droit de les modifier : ce droit devra être réservé à l’administration.
